...
| **Actual: not ring** | FP = 0 | TN = 37 |

- Precision: 1.000
- Recall: 0.857

## Account-level cost/benefit at this threshold
- Ring fraud value protected (caught): Rs.514,278.89
- Ring fraud value still missed: Rs.19,731.54
- Legitimate accounts wrongly caught in a flagged cluster: 10 total -- 10 coincidental/benign-lookalike (100%), 0 other (0%)
- Cost of those false positives, at 1x avg order value per account: Rs.8,879.07
- **Net: protects Rs.514,279 of fraud at a cost of roughly
  Rs.8,879 in false-positive review/friction (at a conservative
