...
## Cluster-level confusion matrix (out-of-fold, 56 clusters)
...
- Ring fraud value protected (caught): Rs.507,292.19
- Ring fraud value still missed: Rs.19,103.18
- Legitimate accounts wrongly caught in a flagged cluster: 4 total -- 4 coincidental/benign-lookalike (100%), 0 other (0%)
- Cost of those false positives, at 1x avg order value per account: Rs.3,566.22
- **Net: protects Rs.507,292 of fraud at a cost of roughly
  Rs.3,566 in false-positive review/friction (at a conservative
  1x-avg-order-value cost assumption) -- a ~142x return.**

## Honest limitations of this number
- N=56 clusters (18 flagged at this threshold) -- treat
