...
- Ring fraud value protected (caught): Rs.495,477.94
...
- Cost of those false positives, at 1x avg order value per account: Rs.7,115.20
- **Net: protects Rs.495,478 of fraud at a cost of roughly
  Rs.7,115 in false-positive review/friction (at a conservative
  1x-avg-order-value cost assumption) -- a ~70x return.**
...
- Total cost at the locked threshold: 95% CI = [Rs.0, Rs.16,899]
- Each resample's OWN cost-optimal threshold: min=0.7967, median=0.7967, max=0.9710
