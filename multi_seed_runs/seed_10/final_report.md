...
## Cluster-level confusion matrix (out-of-fold, 53 clusters)
| | Predicted: ring | Predicted: not ring |
|---|---|---|
| **Actual: ring** | TP = 18 | FN = 2 |
| **Actual: not ring** | FP = 0 | TN = 33 |

- Precision: 1.000
- Recall: 0.900

## Account-level cost/benefit at this threshold
- Ring fraud value protected (caught): Rs.468,815.08
- Ring fraud value still missed: Rs.12,674.00
- Legitimate accounts wrongly caught in a flagged cluster: 4 total -- 4 coincidental/benign-lookalike (100%), 0 other (0%)
- Cost of those false positives, at 1x avg order value per account: Rs.3,557.60
- **Net: protects Rs.468,815 of fraud at a cost of roughly
  Rs.3,558 in false-positive review/friction (at a conservative
  1x-avg-order-value cost assumption) -- a ~132x return.**

## Honest limitations of this number
- N=53 clusters (18 flagged at this threshold) -- treat
