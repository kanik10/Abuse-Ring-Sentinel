...
## Cluster-level confusion matrix (out-of-fold, 58 clusters)
| | Predicted: ring | Predicted: not ring |
|---|---|---|
| **Actual: ring** | TP = 18 | FN = 1 |
| **Actual: not ring** | FP = 0 | TN = 39 |

- Precision: 1.000
- Recall: 0.947

## Account-level cost/benefit at this threshold
- Ring fraud value protected (caught): Rs.571,201.95
- Ring fraud value still missed: Rs.5,764.96
- Legitimate accounts wrongly caught in a flagged cluster: 13 total -- 13 coincidental/benign-lookalike (100%), 0 other (0%)
- Cost of those false positives, at 1x avg order value per account: Rs.11,568.94
- **Net: protects Rs.571,202 of fraud at a cost of roughly
  Rs.11,569 in false-positive review/friction (at a conservative
  1x-avg-order-value cost assumption) -- a ~49x return.**

## Honest limitations of this number
- N=58 clusters (18 flagged at this threshold) -- treat
...
- Recall at the locked threshold: 95% CI = [0.824, 1.000]
- Total cost at the locked threshold: 95% CI = [Rs.3,560, Rs.34,677]
- Each resample's OWN cost-optimal threshold: min=0.4595, median=0.4595, max=0.9904
- 63.8% of resamples had their own optimum within
