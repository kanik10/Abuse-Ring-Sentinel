...
## Cluster-level confusion matrix (out-of-fold, 54 clusters)
| | Predicted: ring | Predicted: not ring |
|---|---|---|
| **Actual: ring** | TP = 18 | FN = 2 |
| **Actual: not ring** | FP = 0 | TN = 34 |

- Precision: 1.000
- Recall: 0.900

## Account-level cost/benefit at this threshold
- Ring fraud value protected (caught): Rs.543,406.53
- Ring fraud value still missed: Rs.14,824.02
- Legitimate accounts wrongly caught in a flagged cluster: 11 total -- 11 coincidental/benign-lookalike (100%), 0 other (0%)
- Cost of those false positives, at 1x avg order value per account: Rs.9,789.10
- **Net: protects Rs.543,407 of fraud at a cost of roughly
  Rs.9,789 in false-positive review/friction (at a conservative
  1x-avg-order-value cost assumption) -- a ~56x return.**

## Honest limitations of this number
- N=54 clusters (18 flagged at this threshold) -- treat
