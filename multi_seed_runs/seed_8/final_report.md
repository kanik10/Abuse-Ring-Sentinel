...
- Ring fraud value protected (caught): Rs.447,194.26
- Ring fraud value still missed: Rs.23,666.96
- Legitimate accounts wrongly caught in a flagged cluster: 4 total -- 4 coincidental/benign-lookalike (100%), 0 other (0%)
- Cost of those false positives, at 1x avg order value per account: Rs.3,541.72
- **Net: protects Rs.447,194 of fraud at a cost of roughly
  Rs.3,542 in false-positive review/friction (at a conservative
  1x-avg-order-value cost assumption) -- a ~126x return.**

## Honest limitations of this number
- N=54 clusters (16 flagged at this threshold) -- treat
