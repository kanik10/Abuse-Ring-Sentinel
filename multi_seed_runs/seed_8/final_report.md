...
- Ring fraud value protected (caught): Rs.474,095.87
...
- **Net: protects Rs.474,096 of fraud at a cost of roughly
  Rs.3,542 in false-positive review/friction (at a conservative
  1x-avg-order-value cost assumption) -- a ~134x return.**
...
- Total cost at the locked threshold: 95% CI = [Rs.0, Rs.10,625]
- Each resample's OWN cost-optimal threshold: min=0.7152, median=0.7152, max=0.9841
