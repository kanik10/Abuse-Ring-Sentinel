...
## Cluster-level confusion matrix (out-of-fold, 50 clusters)
| | Predicted: ring | Predicted: not ring |
|---|---|---|
| **Actual: ring** | TP = 18 | FN = 1 |
| **Actual: not ring** | FP = 0 | TN = 31 |

- Precision: 1.000
- Recall: 0.947

## Account-level cost/benefit at this threshold
- Ring fraud value protected (caught): Rs.552,389.57
...
- Cost of those false positives, at 1x avg order value per account: Rs.4,433.47
- **Net: protects Rs.552,390 of fraud at a cost of roughly
  Rs.4,433 in false-positive review/friction (at a conservative
  1x-avg-order-value cost assumption) -- a ~125x return.**

## Honest limitations of this number
- N=50 clusters (18 flagged at this threshold) -- treat
