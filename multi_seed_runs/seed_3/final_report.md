...
## Cluster-level confusion matrix (out-of-fold, 66 clusters)
| | Predicted: ring | Predicted: not ring |
|---|---|---|
| **Actual: ring** | TP = 20 | FN = 0 |
| **Actual: not ring** | FP = 0 | TN = 46 |

- Precision: 1.000
- Recall: 1.000

## Account-level cost/benefit at this threshold
- Ring fraud value protected (caught): Rs.560,573.63
- Ring fraud value still missed: Rs.0.00
- Legitimate accounts wrongly caught in a flagged cluster: 11 total -- 11 coincidental/benign-lookalike (100%), 0 other (0%)
- Cost of those false positives, at 1x avg order value per account: Rs.9,708.01
- **Net: protects Rs.560,574 of fraud at a cost of roughly
  Rs.9,708 in false-positive review/friction (at a conservative
  1x-avg-order-value cost assumption) -- a ~58x return.**

## Honest limitations of this number
- N=66 clusters (20 flagged at this threshold) -- treat
...
- Total cost at the locked threshold: 95% CI = [Rs.1,765, Rs.20,299]
- Each resample's OWN cost-optimal threshold: min=0.7705, median=0.7705, max=0.9892
