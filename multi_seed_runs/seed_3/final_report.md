...
## Cluster-level confusion matrix (out-of-fold, 55 clusters)
| | Predicted: ring | Predicted: not ring |
|---|---|---|
| **Actual: ring** | TP = 18 | FN = 2 |
| **Actual: not ring** | FP = 0 | TN = 35 |

- Precision: 1.000
- Recall: 0.900

## Account-level cost/benefit at this threshold
- Ring fraud value protected (caught): Rs.542,701.58
- Ring fraud value still missed: Rs.7,863.81
- Legitimate accounts wrongly caught in a flagged cluster: 6 total -- 6 coincidental/benign-lookalike (100%), 0 other (0%)
- Cost of those false positives, at 1x avg order value per account: Rs.5,295.28
- **Net: protects Rs.542,702 of fraud at a cost of roughly
  Rs.5,295 in false-positive review/friction (at a conservative
  1x-avg-order-value cost assumption) -- a ~102x return.**

## Honest limitations of this number
- N=55 clusters (18 flagged at this threshold) -- treat
