...
- Ring fraud value protected (caught): Rs.439,355.52
- Ring fraud value still missed: Rs.0.00
- Legitimate accounts wrongly caught in a flagged cluster: 8 total -- 8 coincidental/benign-lookalike (100%), 0 other (0%)
- Cost of those false positives, at 1x avg order value per account: Rs.7,150.69
- **Net: protects Rs.439,356 of fraud at a cost of roughly
  Rs.7,151 in false-positive review/friction (at a conservative
  1x-avg-order-value cost assumption) -- a ~61x return.**
...
- Total cost at the locked threshold: 95% CI = [Rs.894, Rs.15,195]
- Each resample's OWN cost-optimal threshold: min=0.7168, median=0.7168, max=0.9855
